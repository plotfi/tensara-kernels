"""Triton solution for `cs4803dgc-lab3-conv2d-shared-constant` (2D 5x5 convolution, 512x512, zero-padded).
...
def main(do_check):
    ...
    if do_check:
        ...
        return tb.check("cs4803dgc-lab3-conv2d-shared-constant", P.view(sz, sz), ref, rtol=1e-2, atol=1e-2)
    return 0


if __name__ == "__main__":
    tb.run("cs4803dgc-lab3-conv2d-shared-constant", main)
