// Metal solution wrapper for "hard-sigmoid" (unified activation kernel, 8 elems/thread).
#include "../tensor-lib/tensor.cuh"

METAL_KERNEL("hard-sigmoid", R"(
// Metal shader for "hard-sigmoid" -- unified activation kernel, op = HardSigmoid.
...
kernel void solution(device const float* A [[buffer(0)]],
    ...
    activation_x8<HardSigmoid>(A, C, n, alpha, gid);
}
)");
