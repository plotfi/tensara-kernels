// Metal solution wrapper for "gelu" (unified activation kernel, 8 elems/thread).
#include "../tensor-lib/tensor.cuh"

METAL_KERNEL("gelu", R"(
// Metal shader for "gelu" -- unified activation kernel, op = Gelu.
...
kernel void solution(device const float* A [[buffer(0)]],
    ...
    activation_x8<Gelu>(A, C, n, alpha, gid);
}
)");
