// Metal solution wrapper stub for "lower-trig-matmul" (unimplemented).
// Dispatches the no-op stub shader. Once implemented, bind the real
// buffers (tensor::buf(ptr)) and scalars (tensor::arg(v)) and dispatch
// over the output, mirroring the CUDA solution.
#include "../tensor-lib/tensor.cuh"

METAL_KERNEL("lower-trig-matmul", R"(
// Metal shader stub for "lower-trig-matmul" (unimplemented). Fill in like the CUDA
