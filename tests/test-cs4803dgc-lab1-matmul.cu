// Correctness test for cs4803dgc-lab1-matmul (C = A * B, square 32x32) vs a CPU gold
// (matches CS4803VGCD/lab1/matrixmul_gold.cpp).
...
int main() {
    ...
    solution(dA, dB, dC, n);
    test::check_cuda("cs4803dgc-lab1-matmul");
    dC.download(hC);
    ...
    int bad = test::compare("cs4803dgc-lab1-matmul", hC, hRef, n*n, 1e-3f, 1e-4f);
    int rc = test::report("cs4803dgc-lab1-matmul", bad, n*n);
