// Correctness test for cs4803dgc-lab3-conv2d-shared (2D 5x5 convolution, 64x64) vs a CPU gold
...
int main() {
    ...
    test::check_cuda("cs4803dgc-lab3-conv2d-shared");
    dP.download(hP);
    ...
    int bad = test::compare("cs4803dgc-lab3-conv2d-shared", hP, hRef, sz*sz, 1e-3f, 1e-4f);
    int rc = test::report("cs4803dgc-lab3-conv2d-shared", bad, sz*sz);
